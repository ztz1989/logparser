...
doubleDictionaryList, triDictionaryList, allTokenList = dictionaryBuilder(HealthApp_format, '/root/logparser/logs/HealthApp/HealthApp_2k.log', HealthApp_Regex)
tokenMatch(allTokenList,doubleDictionaryList,triDictionaryList,15,10,'Output/HealthApp')
f_measure, accuracy = evaluate('/root/logparser/logs/HealthApp/HealthApp_2k.log_structured.csv', 'Output/HealthAppEvent.csv')
