...
for dataset, setting in benchmark_settings.iteritems():
    ...
    thresholds = 0.01*np.arange(50,101) #[0.5, 0.6, 0.7, 0.8, 0.85, 0.86, 0.87, 0.88, 0.89, 0.9, 0.91, 0.92, 0.93, 0.94,0.95, 1]

    for t in thresholds:
	print("Threshold: ", t)
    	parser = LenMa.LogParser(log_format=setting['log_format'], indir=indir, outdir=output_dir, rex=setting['regex'], threshold=t)
